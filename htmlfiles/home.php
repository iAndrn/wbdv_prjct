...
<div class=" mainrow"> 
 ...
 <!--        <div ">
  ...
  <div class="row">
      <div  class="col-7"> 
      <h1 style="font-family: courier" >About DIY</h1>
        <br>
      <p class="text-justify" style="line-height:25px;">Launched in 2017, DIY organizes Events and offers different products for Birtyday and Baptismal Parties. </p>
    </div>
    <div  class="col-5"> 
      <img class="img-responsive"   width="430" height="250" src="../DIY PICTURES/3.jpg">
    </div>
  </div>
  <hr/>
      <h1 style="font-family: courier" align=" right" >Services</h1>
      <p align=" right">Catering | Event Styling | Party Needs</p>
    <hr/>
      <h1 style="font-family: courier" >Mission</h1>
      <p>Our mission is to provide our clients with affordable yet good quality of products and services.</p>
      <hr />
    </div>
